...
module.exports = {
  ...
  theme: {
    extend: {
      // Modern, light color palette (Salesforce/Google inspired)
      colors: {
        // Primary - Soft blue (like Google/Salesforce)
        primary: {
          50: '#f0f7ff',
          100: '#e0efff',
          200: '#bae0ff',
          300: '#7cc4ff',
          400: '#36a3ff',
          500: '#0b84ff',  // Main primary
          600: '#0066db',
          700: '#0052b0',
          800: '#004491',
          900: '#003a78',
        },
        // Neutral - Very light grays
        gray: {
          25: '#fcfcfd',
          50: '#f9fafb',
          100: '#f3f4f6',
      ...
      // Light, subtle shadows (Google style)
      boxShadow: {
